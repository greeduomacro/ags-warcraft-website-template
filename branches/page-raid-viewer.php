...
<section id="raidviewer">
	<div class="top">
        <div>
            <a id="signup" href="#" class="agsButton">Add/Edit Signup</a>
            <div style='display:none'>
                <div id="signup-form">
                    <form class="AGS_Form" action="index.html" method="post">
                    <fieldset>
                        <label>Post a shoutbox message</label>
                        <section>
                            <label for="shoutbox_visibility">Visibility</label>
                            <div><select name="shoutbox_visibility" id="shoutbox_visibility"><option value="1">Everyone</option><option value="2">Guild members</option></select></div>
                        </section>
                        <section>
                            <label for="shoutbox_message">Message</label>
                            <div><textarea name="shoutbox_message" id="shoutbox_message" class="smileys"></textarea></div>
                        </section>
                        
                        <button class="agsButtonIconText" rel="ui-icon-pencil">Post message</button>
                    </form>
                </div>
            </div>            
    ...
    <div class="mid">
    	<div>
            ...
            <ul id="available" class="connected">
            	<li class="hunter" data-id="6" title="Signed up 2 days ago<br>Signup changed 2 minutes ago"><figure class="avatar"><img src="/data/avatars/6.jpg"></figure><a href="#" class="hunter">Bofire <span>Melee DPS, 15.9 PR<br> 95% Attendance </span></a></li>
                <li class="shaman" data-id="2" title="Signed up 2 days ago<br>Signup changed 2 minutes ago"><figure class="avatar"><img src="/data/avatars/2.jpg"></figure><a href="#" class="shaman">Ynnah <span>Healer, 35.2 PR <br> 95% Attendance </span></a></li>
				<li class="mage" data-id="1" title="Signed up 2 days ago<br>Signup changed 2 minutes ago"><figure class="avatar"><img src="/data/avatars/1.jpg"></figure><a href="#" class="mage">Yugo <span>Ranged DPS, 15.9 PR <br> 95% Attendance </span></a></li>
                <li class="priest" data-id="4" title="Signed up 2 days ago<br>Signup changed 2 minutes ago"><figure class="avatar"><img src="/data/avatars/4.jpg"></figure><a href="#" class="priest">Coras <span>Healer, 15.9 PR <br> 95% Attendance </span></a></li>
                <li class="warlock" data-id="5" title="Signed up 2 days ago<br>Signup changed 2 minutes ago"><figure class="avatar"><img src="/data/avatars/5.jpg"></figure><a href="#" class="warlock">Oddap <span>Melee DPS, 15.9 PR<br> 95% Attendance </span></a></li>
