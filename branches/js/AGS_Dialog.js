    ...
    $.widget( "custom.AGS_Dialog" , {
		...
		_loadScripts: function(callback){	
			if(this.options.type == 'form'){
				head.js("/js/jquery/colorbox.js");
				head.js("/js/jquery/easydrag.js");
			} else {
				head.js("/js/jquery/ui/jquery.ui.draggable.min.js");
				head.js("/js/jquery/ui/jquery.ui.resizable.min.js");
				head.js("/js/jquery/ui/jquery.ui.button.min.js");
				head.js("/js/jquery/ui/jquery.ui.dialog.min.js");
			}
			head.ready(callback);
		},
